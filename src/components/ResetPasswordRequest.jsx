...
const ResetPasswordRequest = (props) => {
  ...
  const confirmAccept = () => {
    ...
    setRequests((prev) =>
      prev.map((item) =>
        item.id === selectedRequest.id ? { ...item, status: "Accepted" } : item
      )
    );
        ...
        <div className="max-w-6xl mx-auto">
          <section className="rounded-3xl bg-white text-black shadow-sm border border-black/10 p-5 md:p-6 space-y-6">
            <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
              <div>
                <h1 className="text-2xl font-semibold">Reset Password Request</h1>
                <p className="text-sm text-black/60">
                  Validasi request reset password (Accept/Reject).
                </p>
              </div>
              ...
              <div className="flex items-start justify-between gap-3">
                <div>
                  ...
                  <p className="mt-1 text-sm text-black/60">
                    Apakah kamu yakin ingin <span className="font-semibold">ACCEPT</span> request ini?
                  </p>
                </div>
                <button
                  type="button"
            ...
            <div className="relative w-full max-w-md rounded-2xl bg-white p-5 text-black shadow-xl">
              <div className="flex items-start justify-between gap-3">
                <div>
                  ...
                  <p className="mt-1 text-sm text-black/60">
                    Apakah kamu yakin ingin <span className="font-semibold">REJECT</span> request
                    dengan username{" "}
