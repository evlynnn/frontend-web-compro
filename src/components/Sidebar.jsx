  ...
  return (
    ...
    >
      ...
      <span
        ...
        className="absolute top-1 left-1 w-5 h-5 rounded-full shadow-md transition-all duration-200 pointer-events-none"
      />
    </button>
  );
};
        ...
        <div className="flex flex-col flex-1 min-h-0">
          ...
          <nav className="flex flex-col flex-1 min-h-0 space-y-1 text-sm">
            ...
            <button
              ...
              className="w-full text-left px-3 py-2 rounded-2xl text-white/80 dark:text-gray-700 hover:bg-red-500/10 hover:text-red-400 transition font-semibold"
            >
              Logout
            </button>
          </nav>
